 ...
 * May return partial first line if the last line alone exceeds byte limit.
 */
 ...
 */
export const truncateLine = (line: string, maxChars: number = GREP_MAX_LINE_LENGTH): { text: string; wasTruncated: boolean } => {
