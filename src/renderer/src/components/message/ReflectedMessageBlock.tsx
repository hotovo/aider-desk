...
export const ReflectedMessageBlock = ({ baseDir, message, allFiles }: Props) => {
  ...
  return (
    <div className="rounded-md p-3 mb-2 max-w-full text-xs bg-neutral-900/50 border border-neutral-800/50 text-text-mutedLight  relative group break-words whitespace-pre-wrap">
