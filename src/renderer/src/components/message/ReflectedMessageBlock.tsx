...
export const ReflectedMessageBlock = ({ baseDir, message, allFiles }: Props) => {
  ...
  return (
    <div className="rounded-md p-3 mb-2 max-w-full text-xs bg-bg-primary-light-strong border border-border-dark-light-strong text-text-mutedLight  relative group break-words whitespace-pre-wrap">
