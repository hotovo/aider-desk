        ...
        parts.push(
          <ReactMarkdown
            ...
            components={{
              ...
              a: (props) => <a className="text-infoLight hover:underline" target="_blank" rel="noopener noreferrer" {...props} />,
              ...
              pre: (props) => <pre className="bg-bg-primaryLight p-2 rounded my-2 overflow-x-auto" {...props} />,
            }}
          >
            {currentText.trimEnd()}
          </ReactMarkdown>,
