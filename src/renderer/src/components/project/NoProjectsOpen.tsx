    ...
    <div className="absolute inset-0 flex flex-col items-center justify-center text-text-mutedLight">
      <div className="text-center max-w-md">
        ...
        <div className="space-y-4">
          <button
            className="px-6 py-3 border border-border-default rounded hover:bg-bg-tertiary30 hover:text-text-secondary transition-colors duration-200 text-md font-medium mb-4 text-text-secondary"
