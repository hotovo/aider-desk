...
export const TaskStatusIcon = ({ taskId, state, isCollapsed, showSpinner }: Props) => {
  ...
  return state === DefaultTaskState.InProgress || showSpinner ? <CgSpinner className={clsx('animate-spin', iconSize, 'text-text-primary')} /> : null;
};
