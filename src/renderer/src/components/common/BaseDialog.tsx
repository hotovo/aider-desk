    ...
    <div className="fixed inset-0 top-0 bottom-0 left-0 right-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4 overflow-y-auto">
      ...
      >
        <div
          ...
          className="bg-bg-secondaryLightStrongest shadow-2xl rounded-xl border border-bg-tertiaryStrong max-h-[90vh] flex flex-col"
          ref={dialogRef}
        >
          <div className="px-6 py-4 border-b border-bg-tertiaryStrong flex-shrink-0">
          ...
          <div className="px-6 py-4 border-t border-bg-tertiaryStrong flex justify-end space-x-3 flex-shrink-0">
            {footer || (
