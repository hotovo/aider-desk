...
import { z } from 'zod';
import { CreateTaskParams, ProjectSettingsSchema, TaskDataSchema } from '@aider-desk/common/types';
...
const PatchProjectSettingsSchema = ProjectSettingsSchema.partial().extend({
  projectDir: z.string().min(1, 'Project directory is required'),
});
