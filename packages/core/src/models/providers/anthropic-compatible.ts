import { Model, ProviderProfile, SettingsData } from '@aider-desk/common/types';
import { DEFAULT_MODEL_TEMPERATURE, isAnthropicCompatibleProvider, AnthropicCompatibleProvider } from '@aider-desk/common/agent';
