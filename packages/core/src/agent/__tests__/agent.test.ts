...
import { ToolApprovalState } from '@aider-desk/common/types';
import { POWER_TOOL_FILE_READ, POWER_TOOL_GROUP_NAME, TOOL_GROUP_NAME_SEPARATOR } from '@aider-desk/common/tools';
import { fileTypeFromBuffer } from 'file-type';
import { v4 as uuidv4 } from 'uuid';

import type { ContextFile } from '@aider-desk/common/types';
