...
import {
  ...
  UserMessageData,
  WorkingMode,
} from '@aider-desk/common/types';
import { extractProviderModel, extractTextContent, fileExists, parseUsageReport } from '@aider-desk/common/utils';
import { COMPACT_CONVERSATION_AGENT_PROFILE, CONFLICT_RESOLUTION_PROFILE, HANDOFF_AGENT_PROFILE, INIT_PROJECT_AGENTS_PROFILE } from '@aider-desk/common/agent';
import { v4 as uuidv4 } from 'uuid';
import debounce from 'lodash/debounce';
import { isEqual } from 'lodash';

import type { SimpleGit } from 'simple-git';
import type { WorkflowExecutionResult } from '@aider-desk/common/bmad-types';
