...
import { ApplicationAPI, OpenDialogOptions, OpenDialogReturnValue, ContextMenuParams } from '@aider-desk/common/api';
import axios, { type AxiosInstance } from 'axios';
import { io, Socket } from 'socket.io-client';
import { compareBaseDirs } from '@aider-desk/common/utils';
import { v4 as uuidv4 } from 'uuid';

import type { BmadStatus } from '@aider-desk/common/bmad-types';
