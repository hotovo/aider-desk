...
|---------------------------------------------------------------------------------------------------------------------------------------------|-------------|-----------|
| [binary-files](https://github.com/hotovo/aider-desk/tree/main/packages/extensions/extensions/binary-files/)                                  | Attaches local binary files such as images, PDFs, Office documents, audio, and video to multimodal model requests | `getTools` |
...
| [git-log](https://github.com/hotovo/aider-desk/tree/main/packages/extensions/extensions/git-log/)                                           | Browse the git history of open projects with an IntelliJ IDEA-style log viewer (virtualized commit list, infinite scroll, diffs) | `onLoad`, `getUIComponents`, `getUIExtensionData`, `executeUIExtensionAction`, `onProjectStarted`, `onProjectStopped`, `triggerUIDataRefresh` |
...
| [task-scheduler](https://github.com/hotovo/aider-desk/tree/main/packages/extensions/extensions/task-scheduler/)                             | Schedule tasks to run automatically on a cron or periodic basis | `onLoad`, `onUnload`, `getCommands`, `getUIComponents`, `getUIExtensionData`, `executeUIExtensionAction`, `onProjectStarted`, `onProjectStopped`, `onTaskClosed`, `TaskContext.updateTask`, `triggerUIDataRefresh` |
| [reasoning-selector](https://github.com/hotovo/aider-desk/tree/main/packages/extensions/extensions/reasoning-selector/)                     | Adds a reasoning-effort selector next to the model selector in Agent Mode | `onLoad`, `onUnload`, `onTaskCreated`, `getUIComponents`, `getUIExtensionData`, `executeUIExtensionAction`, `onAgentStarted`, `TaskContext.updateTask`, `triggerUIDataRefresh` |
