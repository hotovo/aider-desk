...
:::tip[Updated Files]
For a complete overview of how to track and interact with modified files, including making inline code requests, see the **[Updated Files](../features/updated-files.md)** documentation.
:::
...
![Diff code block with the Undo icon in its top-right corner](../images/core-reviewing-changes-undo-button.png)
...
The diff viewer modal (accessed via the [Updated Files](../features/updated-files.md) section) supports **inline code requests**, allowing you to request changes directly on specific lines.
...
![Inline comment dialog on a diff viewer line](../images/core-inline-code-request-comment.png)
...
For detailed best practices and more examples, see the **[Updated Files](../features/updated-files.md)** documentation.

## Related Features

- **[Updated Files](../features/updated-files.md)** - Track all modified files and make inline code requests
