/**
 * AiderDesk Electron Main Process
 *
 * This is the entry point for the Electron app.
 * It uses @aider-desk/core for business logic and handles Electron-specific functionality.
 */

import { join } from 'path';
import { existsSync, statSync } from 'fs';

import { compareBaseDirs, delay } from '@aider-desk/common/utils';
